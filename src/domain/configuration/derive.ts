import { getItem, getItems, meta } from "@/data/catalog";
import type { DesignConfiguration } from "./schema";
import { estimateAquarium, type AquariumEstimates } from "@/domain/aquarium/volume";
